  ...
  return (
    <div>
      <header className="mb-8">
        <span className="kicker">General AI interview</span>
        <h1 className="mt-3 text-[clamp(28px,3.4vw,40px)] font-extrabold leading-[1.1] tracking-[-0.015em]">
          A standardised read on the work you have actually done
        </h1>
        <p className="mt-4 max-w-[68ch] text-[15.5px] leading-7 text-foreground/78">
          Every candidate is measured against the same five competencies, so
          scores compare like for like. The questions are yours alone — they come
          from the challenge days you have completed.
        </p>
      </header>
      ...
      {stage === "identity" && (
        <StageIdentity
          candidateName={overview.candidateName}
